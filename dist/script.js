...
var changeModalState = function changeModalState(state) {
  ...
  var bindActionToElement = function bindActionToElement(event, elem, prop) {
...
var img = function img() {
  var calcScrollImg = function calcScrollImg() {
  ...
  workSection.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains('preview')) {
      ...
      document.body.style.marginRight = "".concat(scrollImg, "px");
    }
...
var tabs = function tabs(headerSelecttor, tabSelector, contentSelector, activeClass) {
  var display = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  var header = document.querySelector(headerSelecttor);
  var tab = document.querySelectorAll(tabSelector);
  var content = document.querySelectorAll(contentSelector);

  var hideTabContetn = function hideTabContetn() {
  ...
  var showTabContetn = function showTabContetn() {
